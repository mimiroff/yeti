...
$lot_hours_remaining = (($tomorrow - $now) / 3600) >= 10 ? ''.floor(($tomorrow - $now) / 3600) : '0'.floor(($tomorrow - $now) / 3600);
$lot_minutes_remaininig = ((($tomorrow - $now) % 3600) / 60) >= 10 ? ''.floor((($tomorrow - $now) % 3600) / 60) : '0'.floor((($tomorrow - $now) % 3600) / 60);    
